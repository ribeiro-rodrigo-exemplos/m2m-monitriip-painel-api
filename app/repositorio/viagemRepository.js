...
class ViagemRepository {
        ...
        extratos(){
            ...
            logger.info(`ViagemRepository - extratos`);
        ...
        totalizadores(){
            ...
            logger.info('ViagemRepository - totalizadores')

            return this._prepareAggregate(query);
        }

        viagem(){
            logger.info('ViagemRepository - viagem');
        ...
        _prepareResult(fields){
            ...
            logger.info(`ViagemRepository - _prepareResult - query - ${JSON.stringify(filtro)}`);
